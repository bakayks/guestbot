...
public class ClaudeService {
    ...
    private String buildDiscoverySystemPrompt(List<Hotel> hotels) {
        ...
        sb.append("- НИКОГДА не говори что гость уже выбрал отель — выбор происходит только нажатием на кнопку.\n");
        sb.append("- НИКОГДА не проси вводить номер из списка. Гость выбирает гостиницу нажатием на кнопку под сообщением.\n");
        sb.append("- Когда гость определился — скажи: 'Нажмите кнопку с названием отеля ниже чтобы продолжить'.\n");
